...
(function () {
  ...
  const PROVIDERS = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          durationMin: 45,
          price: 80,
          subtitle: "Krótkie i średnie włosy, mycie w cenie",
          photos: ["assets/services/svc-women.jpg"],
        },
        {
          id: "svc-gb-6",
  ...
  const DEMO_BOOKINGS = [
    ...
    },
    {
      ...
      clientEmail: "hubert.z@example.com",
      clientAddress: "ul. Kwiatowa 12, Kraków",
      serviceIds: ["svc-gb-2"],
      serviceNames: ["Strzyżenie brody"],
      dateISO: DEMO_TODAY_ISO,
      from: "17:00",
    ...
    {
      id: "bk-demo-gb-cancelled",
      providerId: "grzesiu-barber",
      providerName: "Grzesiu Barber",
      clientName: "Ewa M",
      clientPhone: "+48 530 111 222",
      serviceIds: ["svc-gb-1"],
      serviceNames: ["Strzyżenie męskie"],
      dateISO: DEMO_TODAY_ISO,
      from: "11:30",
    ...
    {
      id: "bk-demo-gb-rejected",
      providerId: "grzesiu-barber",
      providerName: "Grzesiu Barber",
      clientName: "Bartek P",
      clientPhone: "+48 608 333 444",
      serviceIds: ["svc-gb-2"],
      serviceNames: ["Strzyżenie brody"],
      dateISO: DEMO_TODAY_ISO,
      from: "14:00",
