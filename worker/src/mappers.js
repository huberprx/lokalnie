...
export async function mapBooking(row, env) {
  ...
  return {
    ...
    proposedFrom: row.proposed_time_from ?? null,
    proposedTo: row.proposed_time_to ?? null,
    proposedLocationLabel: row.proposed_location_label ?? null,
    rescheduleExpiresAt: row.reschedule_expires_at ?? null,
